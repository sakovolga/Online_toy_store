package com.example.online_toy_store.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.example.online_toy_store.controller.*.*(..))")
    public void controllerLog() {
    }

    @Pointcut("execution(public * com.example.online_toy_store.service.*.*(..))")
